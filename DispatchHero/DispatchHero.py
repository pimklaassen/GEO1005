...
class DispatchHero:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'DispatchHero_{}.qm'.format(locale))
        ...
        self.actions = []
        self.menu = self.tr(u'&Dispatch hero')
        # TODO: We are going to let the user set this up in a future iteration
        self.toolbar = self.iface.addToolBar(u'DispatchHero')
        self.toolbar.setObjectName(u'DispatchHero')

        #print "** INITIALIZING DispatchHero"
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('DispatchHero', message)
    ...
    def unload(self):
        ...
        #print "** UNLOAD DispatchHero"

        for action in self.actions:
            self.iface.removePluginMenu(
                self.tr(u'&Dispatch hero'),
                action)
